...
type CartService interface {
	AddItem(ctx context.Context, sessionID string, userID *uuid.UUID, productID uuid.UUID, qty int, isBox bool, markdownItemID *uuid.UUID) (*CartItem, error)
	UpdateItem(ctx context.Context, sessionID string, userID *uuid.UUID, itemID uuid.UUID, qty int) error
	RemoveItem(ctx context.Context, sessionID string, userID *uuid.UUID, itemID uuid.UUID) error
